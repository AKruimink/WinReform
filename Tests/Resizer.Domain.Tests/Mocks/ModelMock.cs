...
namespace Resizer.Domain.Tests.Mocks
{
    ...
    public class ModelMock : IEquatable<ModelMock>, IComparable<ModelMock>
    {
        ...
        public bool Equals([AllowNull] ModelMock other) => other?.Id == Id && other?.SomeText == SomeText;
        ...
        public override int GetHashCode() => (Id, SomeText).GetHashCode();
